...
function applyGuestPermissions() {
    ...
    // Hide restricted tab navigation buttons
    ...
    if (!badge) {
        ...
        badge.style.cssText = 'background: #fff3cd; color: #856404; text-align: center; padding: 10px; border-radius: 6px; margin-bottom: 15px; font-weight: bold;';
        badge.innerText = '👀 מצב אורח: גישה למחולל הארוחות בלבד';
        appContainer.insertBefore(badge, appContainer.firstChild);
    }

    // Force active tab to Meal Generator (Sandbox)
