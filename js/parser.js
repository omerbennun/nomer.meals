...
function parseHebrewQuantityAndUnit(line) {
    ...
    const descriptorsRegex = /חתוך לקוביות|פרוסות|פרוסים|פרוסה|פרוס(?!\p{L})|מגוררות|מגוררים|מגוררת|מגורר(?!\p{L})|כתושות|כתושים|כתושה|כתוש(?!\p{L})|קלופות|קלופים|קלופה|קלוף(?!\p{L})|קצוצות|קצוצים|קצוצה|קצוץ(?!\p{L})|מרוסקת|מרוסק(?!\p{L})|מעוכה|מעוך(?!\p{L})|רצועות|טרייה|טריים|טריות|טרי(?!\p{L})|קפואה|קפואים|קפואות|קפוא(?!\p{L})|יבשה|יבשים|יבשות|יבש(?!\p{L})|מבושלת|מבושלים|מבושלות|מבושל(?!\p{L})|אפויה|אפויים|אפויות|אפוי(?!\p{L})|מטוגנת|מטוגנים|מטוגנות|מטוגן(?!\p{L})|קלויה|קלויים|קלויות|קלוי(?!\p{L})|מושרים|מושרות|מושרה|שטופים|שטופות|שטופה|שטוף(?!\p{L})|מנופת|מנופה|סחוטים|סחוטות|סחוטה|סחוט(?!\p{L})|שימורים|מיובשת|מיובש(?!\p{L})|שלמה|שלמים|שלמות|שלם(?!\p{L})|מגורענת|מגורען(?!\p{L})|ללא גרעינים|גדושה|גדוש(?!\p{L})|קמצוץ|לפי הטעם|מעט|הרבה/gu;
